				...
				<ul ref="boxs" class="content-header ziliao">
					...
					<li style="flex:1;position:relative;" class="last" @click.stop="tianjia()">
						...
						<div v-show="daohangblock" class="daohang">
							...
							<span class="centers" @click.stop="daohang('2')"><font class="tubiao2"></font>发布项目</span>
							<span @click.stop="daohang('3')"><font class="tubiao3"></font>发布资金</span>
						</div>
					</li>
				</ul>
...
//					window.location.href="#/wode";
				...
				if(id=='2'){
					window.location.href="#/fabuxiangmu";
				}
				if(id=='3'){
					window.location.href="#/fabuzijin";
				}
			},
			xiangmucont(){
				this.daohangblock=false;
				window.location.href="#/xiangmuxiangqing";
			},
			zijincont(){
				this.daohangblock=false;
				window.location.href="#/zijinxiangqing";
			},
			none(){
