			...
			<div class="box">
				...
				<div class="fankiu-content">
					<div class="zhuying_1 zhuying_2">
						...
						<div class="last">
							<textarea placeholder="单行资金" class="mint-field-core" v-model="texta"></textarea>
						</div>
					</div>
					<div class="zhuying_1 zhuying_2">
					...
					<div style="margin-top:0.2rem;" class="zhuying_1">
						<div class="ferst"><span>*</span>主要项目要求</div>
					...
					<div class="zhuying_1">
						<div class="ferst"><span>*</span>资金成本及审批时间</div>
						<div class="last neirong">
							<textarea placeholder="主要项目要求：资金成本，手续费，审批时间。" class="mint-field-core" v-model="textd"></textarea>
						</div>
						<li>{{y}}/100</li>
					</div>
				</div>
