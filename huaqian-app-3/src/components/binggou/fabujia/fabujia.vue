		...
		<div v-show="tucaoShow" class="xiangmu">
			...
			<div class="box">
				...
				<div class="fankiu-content">
					...
					<div class="zhuying_1 zhuying_2">
						<div class="ferst"><span>*</span>买方上市板块</div>
						<div class="last">
							<textarea readOnly="true" placeholder="" class="mint-field-core" v-model="leixing"></textarea>
							<ul v-show="fuxuanblock" class="xuanxiang">
								<li @click.stap="fuxuan($event)">主板</li>
								<li @click.stap="fuxuan($event)">中小板块</li>
								<li @click.stap="fuxuan($event)">创业板块</li>
								<li @click.stap="fuxuan($event)">新三板</li>
							</ul>
						</div>
					...
					<div style="margin-top:0.2rem;" class="zhuying_1">
						<div class="ferst"><span>*</span>意向收购需求</div>
						<div class="last neirong">
							<textarea placeholder="介绍对收购标的的主要要求" class="mint-field-core" v-model="textc"></textarea>
						</div>
						<li>{{x}}/100</li>
					</div>
					<div class="type-cont">
