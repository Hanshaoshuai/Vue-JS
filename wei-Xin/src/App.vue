<template>
  <div id="app">
    <div
      v-show="this.$store.state.head.hederTop"
      class="heder"
      :style="{ 'border-top': statusbarStyle + 'rem solid ' + Colors }"
    >
      <div
        v-show="
          (this.$store.state.head.to.name &&
        ...
        @click="backOff()"
      ></div>
      <img v-show="SignIn" :src="this.$store.state.head.urlNme" alt="" />
    </div>
    <transition :name="transitionName">
      <div
        v-show="this.$store.state.head.to.name == 'Payment'"
        class="heder"
        :style="{ 'border-top': statusbarStyle + 'rem solid ' + Colors }"
      >
    ...
    <transition :name="transitionName">
      <div
        v-show="this.$store.state.head.to.name == 'Wallet'"
        class="heder"
        :style="{ 'border-top': statusbarStyle + 'rem solid ' + Colors }"
      >
        <div class="backOff" @click="backOff()"></div>
    ...
    <transition :name="transitionName">
      <div
        v-show="this.$store.state.head.to.name == 'SmallChange'"
        class="heder"
        :style="{ 'border-top': statusbarStyle + 'rem solid ' + Colors }"
      >
        <div class="backOff" @click="backOff()"></div>
    ...
    <transition :name="transitionName">
      <div
        v-show="this.$store.state.head.to.name == 'SetUp'"
        class="heder"
        :style="{ 'border-top': statusbarStyle + 'rem solid ' + Colors }"
      >
        <div class="backOff" @click="backOff()"></div>
    ...
    <transition :name="transitionName">
      <div v-show="indexs" class="food border-top">
