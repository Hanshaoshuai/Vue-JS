				...
				<div class="type-content">
					<div class="type-cont">
						...
						<ul>
							<div class="shouru">
								营业收入不低于
								<input v-model="numbera" placeholder="输入数字" number="true" type="number" class="mint-field-core border">万
							</div>
							<div class="shouru">
								净利润不低于
								<input v-model="numberToa" placeholder="输入数字" number="true" type="number" class="mint-field-core border">万
							</div>
							<!--<li class="border">
				...
				<div class="type-content">
					<div class="type-cont">
						...
						<ul>
							...
							万&nbsp;至
							<input v-model="numberToc" placeholder="输入数字" number="true" type="number" class="mint-field-core border">万&nbsp;
						</ul>
					</div>
				</div>
				<div class="type-content">
