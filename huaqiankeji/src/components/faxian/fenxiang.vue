	...
	<html>
		...
		<body>
			<div id="dcontent" class="dcontent">
				...
				<textarea style="display:none;" id="sharecontent" rows="3">我正在使用HBuilder+HTML5开发移动应用，赶紧跟我一起来体验！</textarea>
				<!--<br/><br/>-->
				...
				<img style="display:none;" id="pic" src="../img/add.png"/>
				<!--<br/>-->
				...
				<input style="display:none;" id="sharehref" class="sharehref" type="url" value="http://www.dcloud.io/" placeholder="请输入要分享的链接地址"/>
				<p style="display:none;" class="heading">链接标题：</p>
				<input style="display:none;" id="sharehrefTitle" class="sharehref" type="text" value="DCloud HBuilder-做最好的HTML5开发工具" placeholder="请输入要分享的链接标题"/>
				<p style="display:none;" class="heading">链接描述：</p>
				<input style="display:none;" id="sharehrefDes" class="sharehref" type="text" value="我正在使用HBuilder+HTML5开发移动应用，赶紧跟我一起来体验！" placeholder="请输入要分享的链接描述"/>
