...
//				}
				...
				that.$http.post(URL.path1+'account/info',params,{emulateJSON:true}).then(function(res){
//					console.log('个人信息判断类型是否了');
//					console.log(res);
					if(localStorage.getItem("type")!=res.body.data.ctype){
