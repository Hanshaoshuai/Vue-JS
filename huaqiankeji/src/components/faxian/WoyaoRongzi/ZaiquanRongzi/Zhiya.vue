				...
				<div class="fankiu-content">
					...
					<div class="zhuying_1">
						...
						<div class="last number last-bottom">
							<input v-model="numbera" placeholder="请填写年营收" number="true" type="number" class="mint-field-core">
							<span>亿元</span>
						</div>
					...
					<div class="zhuying_1">
						<div class="ferst"><span>*</span>每股净资产</div>
						<div class="last number">
							<input v-model="numberh" placeholder="请输入数字" number="true" type="number" class="mint-field-core">
							<span>元</span>
						</div>
					</div>
					<div class="zhuying_1">
						<div class="ferst"><span>*</span>质押人持股数</div>
						<div class="last number">
							<input v-model="numberi" placeholder="请输入数字" number="true" type="number" class="mint-field-core">
							<span>股</span>
						</div>
					</div>
					<div class="zhuying_1">
					...
					<div class="zhuying_1">
						<div class="ferst"><span>*</span>是否结合动产、不动产抵押</div>
					</div>
					<div class="fankiu">
						<div class="content-food"  ref="foods">
							<ul>
								...
								<li class="src2" ref="img2" index="img2" @click.stap="zuoshiGo('2')">
									<span>否</span><font></font>
								</li>
							</ul>
						</div>
					</div>
					<div class="zhuying_1">
						<div class="ferst"><span>*</span>用途</div>
						<div class="last number">
							<input v-model="numberj" placeholder="请填写（公司或个人）" type="text" class="mint-field-core">
						</div>
					</div>
					<div class="zhuying_1">
