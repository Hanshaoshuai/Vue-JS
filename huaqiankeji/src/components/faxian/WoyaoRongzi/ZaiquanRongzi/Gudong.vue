		...
		<div v-show="tucaoShow" class="xiangmu">
			...
			<div class="box">
				...
				<div class="fankiu-content">
					...
					<div class="zhuying_1">
						<div class="ferst"><span>*</span>借款股东持股比例</div>
						<div class="last number">
							<input v-model="numberi" placeholder="请输入持股比例" type="text" class="mint-field-core">
						</div>
					</div>
					<div class="zhuying_1">
						<div class="ferst"><span>*</span>借款金额</div>
						<div class="last number">
				...
				if(ok==0){
					...
					this.$http.post(URL.path+'finance/create',datas,{emulateJSON:true}).then(function(res){
						...
						if(res.body.returnCode==202){
							...
							window.location.href='#/GudongJ/1/'+this.XiangmuID+'/1/Pipei';
