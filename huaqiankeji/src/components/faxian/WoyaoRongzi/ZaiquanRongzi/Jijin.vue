		...
		<div v-show="tucaoShow" class="xiangmu">
			...
			<div class="box">
				...
				<div class="fankiu-content">
					<div class="zhuying_1">
						<div class="ferst"><span>*</span>准入条件</div>
						<div class="last neirong">
							<textarea placeholder="请填写准入条件" class="mint-field-core" v-model="textc"></textarea>
						</div>
						<li>{{x}}/100</li>
					</div>
					<div class="zhuying_1">
					...
					<div class="zhuying_1">
						<div class="ferst"><span>*</span>劣后资金规模</div>
						<div class="last number">
