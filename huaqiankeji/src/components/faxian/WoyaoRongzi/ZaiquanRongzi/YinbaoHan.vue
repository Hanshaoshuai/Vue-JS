		...
		<div v-show="tucaoShow" class="xiangmu">
			...
			<div class="box">
				...
				<div class="fankiu-content">
					...
					<div class="zhuying_1">
						<div class="ferst"><span>*</span>受益人性质</div>
						<div class="last">
							<textarea placeholder="如：事业单位、国企、民企、外资、上市公司等" class="mint-field-core" v-model="numbera"></textarea>
						</div>
					</div>
					<div class="zhuying_1">
						<div class="ferst"><span>*</span>申请人资质</div>
						<div class="last number last-bottom">
							<input v-model="numberc" placeholder="请填写申请人资质" type="text" class="mint-field-core">
						</div>
					</div>
					<div class="zhuying_1">
						<div class="ferst"><span>*</span>保函种类</div>
					</div>
					<div class="fankiu">
				...
				if(ok==0){
					...
					this.$http.post(URL.path+'finance/create',datas,{emulateJSON:true}).then(function(res){
						...
						if(res.body.returnCode==202){
							...
							window.location.href='#/YinbaoHanJ/1/'+this.XiangmuID+'/1/Pipei';
