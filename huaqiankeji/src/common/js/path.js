...
//	path3: 'http://www.qironghome.com/index.php/app/' //h5分享页面的地址
   	...
   	path: 'http://test.qironghome.com/bak/web/api/index.php/v2/', //接口地址
// 	path: 'http://test.qironghome.com/bak/web/api/index.php/', //接口地址
   	path2: 'https://47.93.63.26/zbq/web/index.php', //不用授权的接口地址
