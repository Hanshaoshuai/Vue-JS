...
// 	path: 'http://test.qironghome.com/api/index.php/v2/', //接口地址test.qironghome.com/bak/web/api/index.php/upload/photo
// 	path1: 'http://test.qironghome.com/api/index.php/', //接口地址
